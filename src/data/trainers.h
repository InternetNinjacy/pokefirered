const struct Trainer gTrainers[] = {
    ...
    // Pokémon: Weather — Cloudburst reserved trainer slots.
    // Parties are placeholders until the first-run/rematch battle-data implementation pass.
    [TRAINER_STORM_CHASER_SKYE] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE,
        .party = NO_ITEM_DEFAULT_MOVES(sParty_StormChaserSkye),
    },
    [TRAINER_LEADER_RAINA_REMATCH] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY,
        .party = NO_ITEM_DEFAULT_MOVES(sParty_LeaderRainaRematch),
    },
};
