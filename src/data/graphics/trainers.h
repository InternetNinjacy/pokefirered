...
const u32 gTrainerFrontPic_LeaderRaina[] = INCBIN_U32("graphics/trainers/front_pics/leader_raina_front_pic.4bpp.lz");
const u32 gTrainerPalette_LeaderRaina[] = INCBIN_U32("graphics/trainers/palettes/leader_raina.gbapal.lz");
const u32 gTrainerFrontPic_Hydrologist[] = INCBIN_U32("graphics/trainers/front_pics/hydrologist_front_pic.4bpp.lz");
const u32 gTrainerPalette_Hydrologist[] = INCBIN_U32("graphics/trainers/palettes/hydrologist.gbapal.lz");
const u32 gTrainerFrontPic_StormChaser[] = INCBIN_U32("graphics/trainers/front_pics/storm_chaser_front_pic.4bpp.lz");
const u32 gTrainerPalette_StormChaser[] = INCBIN_U32("graphics/trainers/palettes/storm_chaser.gbapal.lz");
