...
#define TRAINER_STORM_CHASER_SKYE                743
#define TRAINER_LEADER_RAINA_REMATCH             744

// Pokémon: Weather semantic aliases for reused first-Gym trainer slots.
#define TRAINER_HYDROLOGIST_WADE                 TRAINER_CAMPER_LIAM
#define TRAINER_LEADER_RAINA                     TRAINER_LEADER_BROCK
